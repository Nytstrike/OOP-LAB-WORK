...
int main(){
    Book book("Crime and Punishment", 1866, "B001", "NA", "Fyodor Dostoevsky", 1234567892, 300);
    DVD dvd("Finding Nemo", 2012, "D007", " Andrew Stanton","Walt Disney Pictures", 100, 8.2);
    CD cd("The Dark Side Of The Moon", 1973, "C010", "Capitol Records", "Pink Floyd", 10, "English Rock");
    Magazine magazine("Time", 2023, "M007", "Time Inc.", "Jason Smith", 50);
