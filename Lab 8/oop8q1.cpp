...
public:
    ...
    void deposit(double amount, string transferBankName, string transferAccNum){
        balance += amount;
        cout << "Amount $" << amount << " deposited online from " << transferBankName << " by account number " << transferAccNum << ". New balance: $" << balance << endl; 
    }
...
int main(){
    ...
    accounts[0] = new SavingsAccount("S-1004", 1500.30);
    accounts[1] = new CurrentAccount("C-1004", 1009.25);
    ...
    accounts[0]->deposit(400, "CHK-0548");
    accounts[0]->deposit(200, "Standard Chartered", "0987654");

    cout << endl << "Deposting money into Current Account:" << endl;
    accounts[1]->deposit(100);
    accounts[1]->deposit(200, "CHK-1004");
    accounts[1]->deposit(300, "Habib BAnk Limited", "12345678");
